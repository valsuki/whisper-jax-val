...
class FlaxPreTrainedModelJax(PushToHubMixin, FlaxGenerationMixin):
    r"""
    Base class for all models.

    [`FlaxPreTrainedModelJax`] takes care of storing the configuration of the models and handles methods for loading,
        ...
        **kwargs,
        ...
        Parameters:
            pretrained_model_name_or_path (`str` or `os.PathLike`):
                Can be either:
                    ...
                    - A path to a *directory* containing model weights saved using
                      [`~FlaxPreTrainedModelJax.save_pretrained`], e.g., `./my_model_directory/`.
            ...
            dtype (`jax.numpy.dtype`, *optional*, defaults to `jax.numpy.float32`):
                ...
                **Note that this only specifies the dtype of the computation and does not influence the dtype of model
                ...
                If you wish to change the dtype of the model parameters, see [`~FlaxPreTrainedModelJax.to_fp16`] and
                [`~FlaxPreTrainedModelJax.to_bf16`].
        ...
        if from_pt:
            ...
            if _do_init:
                ...
                state = jax.tree_util.tree_map(lambda x: jax.device_put(x, jax.devices(os.environ["PJRT_DEVICE"].lower())[0]), state)
        ...
        if len(fp16_params) > 0:
            logger.warning(
                ...
                "See [`~FlaxPreTrainedModelJax.to_fp32`] for further information on how to do this."
            )
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        `[`~FlaxPreTrainedModelJax.from_pretrained`]` class method
...
FlaxPreTrainedModelJax.push_to_hub = copy_func(FlaxPreTrainedModelJax.push_to_hub)
if FlaxPreTrainedModelJax.push_to_hub.__doc__ is not None:
    FlaxPreTrainedModelJax.push_to_hub.__doc__ = FlaxPreTrainedModelJax.push_to_hub.__doc__.format(
